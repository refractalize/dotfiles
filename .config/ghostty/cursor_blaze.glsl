...
const vec4 TRAIL_COLOR = vec4(0.275, 0.522, 0.906, 1.0); // darker tokyonight blue
const vec4 CURRENT_CURSOR_COLOR = TRAIL_COLOR;
const vec4 PREVIOUS_CURSOR_COLOR = TRAIL_COLOR;
const vec4 TRAIL_COLOR_ACCENT = vec4(0.188, 0.396, 0.757, 1.0); // even darker tokyonight blue
